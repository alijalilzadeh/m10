    ...
    <div className='flex flex-col items-center justify-center w-full'>
      <div className="flex flex-col items-center justify-center w-[55%]">
        ...
        <div className="flex items-start justify-start w-full rounded-[20px] bg-white">
          <div className="flex flex-col items-start justify-start w-[60%] pt-6 pl-6 pb-10 pr-10 gap-10">
          ...
          <div className="flex flex-col items-start justify-between rounded-[20px] px-6 py-10 bg-[#2BD5C9] w-[40%]">
            <div className="flex flex-col items-start justify-start ">
              <p className='text-[#141414] font-semibold text-[14px]'>Faiz dərəcəsi</p>
              <h2 className='text-[#141414] font-bold text-[36px]'>10,9% -dən</h2>
            </div>

            <div className="flex flex-col items-start justify-start">
              <p className='text-[#141414] font-semibold text-[14px]'>Aylıq ödəniş</p>
              <h2 className='text-[#141414] font-bold text-[36px]'>{monthlyPayment} ₼</h2>
            </div>
