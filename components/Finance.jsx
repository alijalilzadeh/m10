...
const Finance = ({ financeData }) => {
  return (
    <div className='flex items-center justify-center w-full mt-16 mb-22.5  h-full'>
      <div className="flex flex-col items-center justify-center w-[55%] gap-10 h-full">
        <h2 className='text-[48px] text-[#141414] font-bold text-center'>Maliyyə</h2>
        <div className="flex gap-6 w-full  items-stretch">

          {
            financeData.map((item, id) => (
              <Link className="flex flex-col flex-1 items-center justify-between w-full min-h-47.5 pl-5 pt-5 pr-4 pb-4 rounded-4xl bg-white cursor-pointer group gap-5">
