...
const Footer = () => {
  return (
    <div className='flex flex-col  items-center justify-center w-full rounded-t-4xl bg-[#141414] mt-10'>
      <div className="flex flex-col items-center justify-center w-[85%] py-14 lg:py-22.5 gap-5">
        <div className=" items-center justify-center bg-white rounded-4xl relative w-65 h-65 hidden lg:flex">
          ...
          <img src="https://cdn.prod.website-files.com/687df8fbf77109d01f751481/68d3b2ef48d6490b11ac04b6_m10%20logo.svg" alt="m10 download qr code" className='flex z-4  lg:hidden'/>
        <h2 className='text-[#F4F0EE] text-[48px] font-bold hidden lg:flex'>Tətbiqi yükləmək üçün skan et</h2>
        <h2 className='text-[#F4F0EE] text-[36px] font-bold flex md:text-[48px] lg:hidden'>m10 yüklə</h2>
      ...
      <div className=" items-center justify-between  w-full  py-10 border-t border-t-[#2c2b2b] hidden lg:flex">
      ...
      <div className="flex flex-col gap-10 items-center justify-between  w-full  py-10 border-t border-t-[#2c2b2b]  lg:hidden">
        <div className="flex items-center pl-15 gap-12 justify-center w-full ">
          <Link to='https://www.instagram.com/m10.az/' className='flex items-center justify-center transition duration-200 hover:opacity-80'>
            <img src="https://cdn.prod.website-files.com/687df8fbf77109d01f751481/687e24d22e8ff90ded689f7e_24_icon_instagram.svg" alt="" />
          </Link>
        ...
        <Link to='/' className='flex items-center justify-center transition duration-200 hover:opacity-80 ' reloadDocument>
          <img src="https://cdn.prod.website-files.com/687df8fbf77109d01f751481/687e24d376f98d0fe715e4db_48-logo-m10.svg" alt="m10 footer logo" className='self-center'/>
        </Link>
      </div>
    </div>
  )
