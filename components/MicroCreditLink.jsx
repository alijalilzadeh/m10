...
const MicroCreditLink = () => {
  return (
    <div className='flex items-center justify-center w-[55%] '>
      <Link className="flex flex-col items-start justify-center w-full rounded-4xl bg-[#74BEFF] relative">
        <div className="flex flex-col gap-1 items-start justify-center w-[70%] py-16 pl-8 overflow-hidden">
          ...
          <Link className='text-[#141414] text-[16px] font-semibold underline transition duration-200 opacity-100 hover:opacity-75'>Müraciət et</Link>
        </div>
