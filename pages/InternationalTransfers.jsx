...
const InternationalTransfers = () => {
  ...
  const imgUrls = [
    { url: 'https://cdn.prod.website-files.com/687df8fbf77109d01f751481/69e1eb8ce646a7b8e1c7c576_798f934972ba81b012de4603d9c7e9f6_arch%20l%20az.png' },
    { url: 'https://cdn.prod.website-files.com/687df8fbf77109d01f751481/69e1eb8c43c0998806c9fdff_b9e64375b1fd35cf17ce84f831541bd3_arch%20c%20az.png' },
    { url: 'https://cdn.prod.website-files.com/687df8fbf77109d01f751481/69e1eb8d30e9dfd812e4d5c6_7b80c4c1866d3bb22bd932c916f7997b_arch%20r%20az.png' }
  ]
  ...
  const internationalTransfersData = [
    {
      ...
      desc: 'Pul saniyələr içində alıcıya çatır'
    },
    {
  ...
  const howTo = [
    {
      url: 'https://cdn.prod.website-files.com/687df8fbf77109d01f751481/69de27f7faaa065037d2c2f5_Step%201.svg',
      title: 'Əsas ekranda Köçür → Beynəlxalq pul köçürmələri seçimini et'
    },
    {
      url: 'https://cdn.prod.website-files.com/687df8fbf77109d01f751481/69de27f7125b3715600ece81_Step%202.svg',
      title: 'Alıcının ölkəsini seç'
    },
    {
      url: 'https://cdn.prod.website-files.com/687df8fbf77109d01f751481/69de27f7dd18dd0f69f7a2dd_Step%203.svg',
      title: 'Məbləği və valyutanı qeyd et'
    },
    {
      url: 'https://cdn.prod.website-files.com/687df8fbf77109d01f751481/69de27fa35c3f6ae6519c15c_Step%204.svg',
  ...
  const internationalTransfersFaq = [
    {
      q: 'Pul köçürməsi nə qədər vaxt aparır?',
      a: 'Xaricə pul köçürmələri adətən 2 dəqiqə ərzində həyata keçirilir. Emal müddəti tərəfdaşdan və ödəniş sistemindən asılıdır. Nadir hallarda köçürmə daha çox vaxt apara bilər.'
    },
    {
          ...
          <div className="flex items-center justify-center w-full gap-6">
            {
              whereToTransfer.map((item, id) => (
                <Link className="flex items-center justify-between w-full px-4 py-3 rounded-3xl bg-[#ebe8e7] group opacity-100 transition  duration-200 hover:opacity-90">
